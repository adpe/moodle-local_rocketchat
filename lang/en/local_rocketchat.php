...
$string['privacy:metadata:local_rocketchat'] = 'User account details and course group memberships are sent to the external Rocket.Chat server in order to provision user accounts and keep channel membership in sync. Credentials entered when linking a personal Rocket.Chat account are sent to Rocket.Chat for authentication.';
$string['privacy:metadata:local_rocketchat:email'] = 'The email address of the user, sent to Rocket.Chat when their account is created.';
$string['privacy:metadata:local_rocketchat:fullname'] = 'The full name of the user, sent to Rocket.Chat when their account is created.';
$string['privacy:metadata:local_rocketchat:groupmembership'] = 'The course group memberships of the user, used to add the user to or remove them from the matching Rocket.Chat channels and thereby disclosing their course enrolment.';
$string['privacy:metadata:local_rocketchat:username'] = 'The username for the Rocket.Chat account of the user, derived from the local part of their email address.';
